...
[source,options="nowrap"]
----
/subsystem=elytron/credential-store=exampleCS:read-aliases(recursive=true,verbose=true)
{
    "outcome" => "success",
    "result" => {
        "localhost" => {
...
[[list-all-aliases-recursively-no-keys-in-a-key-store.]]
==== List all aliases(recursively, no keys) in a key store.

[source,options="nowrap"]
----
/subsystem=elytron/credential-store=exampleCS:read-aliases(recursive=true)
{
    "outcome" => "success",
    "result" => {
        "localhost" => {
...
[[read-alias-in-a-key-store.]]
==== Read alias in a key store.

[source,options="nowrap"]
----
/subsystem=elytron/credential-store=exampleCS:read-alias(name="localhost")
{
    "outcome" => "success",
    "result" => {
            "alias" => "localhost",
...
[[read-alias-in-a-key-store-non-verbose.]]
==== Read alias in a key store(non verbose).

[source,options="nowrap"]
----
/subsystem=elytron/credential-store=exampleCS:read-alias(name="localhost",verbose=false)
{
    "outcome" => "success",
    "result" => {
            "alias" => "localhost",
