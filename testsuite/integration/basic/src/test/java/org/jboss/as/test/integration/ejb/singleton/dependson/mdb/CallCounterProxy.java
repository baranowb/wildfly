...
public class CallCounterProxy {
    ...
    private CallCounterInterface getCounter() {
        ...
        try {
            ...
            return (CallCounterInterface) ctx
                    .lookup("java:global/callcounter/CallCounterSingleton!org.jboss.as.test.integration.ejb.singleton.dependson.mdb.CallCounterInterface");
        } catch (Exception e) {
