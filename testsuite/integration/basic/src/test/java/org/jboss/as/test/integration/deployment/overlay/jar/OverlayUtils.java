...
public final class OverlayUtils {
    ...
    public static void setupOverlay(final ManagementClient managementClient, final String deployment, final String overlayName,
            final String overlayPath, final String overlayedContent) throws Exception {
    ...
    public static void removeOverlay(final ManagementClient managementClient, final String deployment,
            final String overlayName, final String overlayPath) throws Exception {
        // TODO: proper cleanup
        try {
    ...
    protected static void removeContentItem(final ManagementClient managementClient, final String w, final String a)
    ...
    protected static void removeDeploymentItem(final ManagementClient managementClient, final String w, final String a)
            throws IOException, MgmtOperationException {
        final ModelNode op;
        final ModelNode addr;
        op = new ModelNode();
